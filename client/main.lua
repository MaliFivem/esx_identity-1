...
function verifyName(name)
	...
	if nameLength > 25 or nameLength < 2 then
		return 'Il nome è troppo lungo o troppo corto.'
	end
	...
	if count ~= nameLength then
		return 'Il nome contiene dei caratteri speciali che non sono permessi.'
	end
	...
	if spacesInName > 2 then
		return 'Nel tuo nome vi sono presenti due spazi'
	end
	
	if spacesWithUpper ~= spacesInName then
		return 'Il tuo nome deve avere la prima lettera maiuscola.'
	end
